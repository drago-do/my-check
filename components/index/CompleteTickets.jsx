...
import ItemTicketCompleteComponent from "./ItemTicketCompleteComponent";
import Skeleton from "../general/Skeleton";
import { useEffect, useState } from "react";

export default function CompleteTickets({ listOfTickets }) {
  ...
  return (
    <div className="flex flex-col">
      <div className="flex flex-nowrap justify-between items-center px-3">
        <Typography variant="subtitle">Tickets completos</Typography>
        <button
      ...
      <div className="flex flex-col">
        {tickets ? (
          tickets.map((ticket, index) => {
            return <ItemTicketCompleteComponent ticket={ticket} key={index} />;
          })
        ) : (
